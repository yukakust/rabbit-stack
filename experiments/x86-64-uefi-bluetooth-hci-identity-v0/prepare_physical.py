...
from rabbit_hci_identity import PROBE_PATH, ROOT, TARGET_PATH, build, load_json


OUTPUT = Path("/tmp/rabbit-bluetooth-hci-identity-v01.img")
REPORT = Path("/tmp/rabbit-bluetooth-hci-identity-v01.json")
...
def main() -> int:
    try:
        ...
        print("This image adds one USB HCI command; exact-device review and explicit authorization remain required.")
