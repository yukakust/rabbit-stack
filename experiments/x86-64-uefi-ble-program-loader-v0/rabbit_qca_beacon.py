#!/usr/bin/env python3
"""Build the bounded UEFI Rabbit VM wireless program loader."""
...
PROGRAM_TEMPLATE_SHA256 = "94f063582a862700f9479a39fdad120cbd4f27f38ba2946fa1ba61afc6716908"
PROGRAM_SHA256 = "db75b6c24d1d9967d49e609b10828d6ab3e78e7b55333090a5b2daf3578e1bc5"
...
def validate_probe(probe: dict[str, Any]) -> None:
    if probe != EXPECTED_PROBE:
        raise BuildError("probe differs from reviewed Rabbit VM loader contract")


def validate_target(target: dict[str, Any]) -> None:
    if target != EXPECTED_TARGET:
        raise BuildError("target differs from reviewed Dell Rabbit VM loader Target Pack")
