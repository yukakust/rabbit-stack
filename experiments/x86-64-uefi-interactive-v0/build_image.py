#!/usr/bin/env python3
"""Build the reviewed Rabbit interactive UEFI image."""
...
from rabbit_interactive import BuildError, TARGET_PATH, WORLD_PATH, build, load_json


def main() -> int:
    parser = argparse.ArgumentParser(description="Build the Rabbit interactive UEFI image")
