#!/usr/bin/env python3
"""Run the receive-only Rabbit beacon artifact through its QEMU negative-path gate."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="rabbit-beacon-rx-qemu-") as temp_dir:
        temp = Path(temp_dir)
        image_path = temp / "rabbit-beacon-rx.img"
