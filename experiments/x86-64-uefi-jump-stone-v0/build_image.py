#!/usr/bin/env python3
"""Build the reviewed jump-and-stone UEFI image."""
...
from rabbit_jump_stone import BuildError, TARGET_PATH, WORLD_PATH, build, load_json


def main() -> int:
    parser = argparse.ArgumentParser(description="Build Rabbit jump-and-stone world")
