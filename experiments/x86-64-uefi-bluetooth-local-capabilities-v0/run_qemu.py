#!/usr/bin/env python3
"""Run the HCI local-capability artifact through its QEMU negative-path gate."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="rabbit-hci-capabilities-qemu-") as temp_dir:
        temp = Path(temp_dir)
        image_path = temp / "rabbit-hci-capabilities.img"
